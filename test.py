import unittest
from main import intersect_segment_plane, intersect_polygon_plane, check_parallel, Segment, Polygon
import numpy as np
...
# class TestCheckParallel(unittest.TestCase):
#     def test_parallel_1(self):
#         s1 = Segment(np.array([1,0,0]), np.array([1,0,1]))
#         s2 = Segment(np.array([2,0,0]), np.array([2,0,1]))
#         self.assertTrue(check_parallel(s1,s2))
    
#     def test_parallel_2(self):
#         s1 = Segment(np.array([1,0,0]), np.array([2,0,0]))
#         s2 = Segment(np.array([1,1,0]), np.array([2,1,0]))
#         self.assertTrue(check_parallel(s1,s2))

#     def test_parallel_3(self):
#         s1 = Segment(np.array([1,0,0]), np.array([2,0,0]))
#         s2 = Segment(np.array([1,0,2]), np.array([2,0,3]))
#         self.assertFalse(check_parallel(s1,s2))

#     def test_parallel_4(self):
#         s1 = Segment(np.array([1,0,0]), np.array([2,0,0]))
#         s2 = Segment(np.array([-1,0],0), np.array([-2,0],0))
#         self.assertTrue(check_parallel(s1,s2))
    
    # def test_parallel_5(self):
    #     s1 = Segment(np.array([-1.846087], -1.846087, -0.01099), np.array([-1.846087], -0.182797, -0.01099))
    #     s2 = Segment(np.array([-1.846087], -0.1827973, -0.01099), np.array([-1.846087], 1.846087, -0.01099))
    #     self.assertTrue(check_parallel(s1,s2))
    
    # def test_parallel_6(self):
    #     s1 = Segment(np.array([-2,] -2, 0), np.array([-2,] -1, 0))
    #     s2 = Segment(np.array([-2,] -1, 0), np.array([-2,] 2, 0))
    #     self.assertTrue(check_parallel(s1,s2))

    # def test_parallel_7(self):
    #     s1 = Segment(np.array([1.846087,] 1.846087, -0.01099), np.array([1.846087,] -0.377563, -0.01099))
    #     s2 = Segment(np.array([-2,] -1, 0), np.array([-2,] 2, 0))
    #     self.assertTrue(check_parallel(s1,s2))
    
    # def test_parallel_8(self):
    #     s1 = Segment(np.array([-1.846087], 1.846087, -0.01099), np.array([1.507202,] 1.846087, -0.01099))
    #     s2 = Segment(np.array([1.846087,] 1.846087, -0.01099),np.array([1.507202,] 1.846087, -0.01099))
    #     self.assertTrue(check_parallel(s1,s2))
